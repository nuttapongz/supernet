...
Source="https://github.com/nuttapongz/supernet/blob/master/ip"
...
if ! grep -w -q $MYIP /usr/bin/IP; then
  ...
  echo " "
  echo "
[+] ขออภัย IP Server ของคุณยังไม่ได้ลงทะเบียนกับ SUPERNET-VPN
...
----------------------------------------------------------------------
             ...
             ยินดีต้อนรับเข้าสู่ SUPERNET-VPN
...
# BannerSSH
wget "https://github.com/nuttapongz/supernet/blob/master/bannersshlink.sh"
...
# Install ScreenFetch
cd
wget -O /usr/bin/screenfetch "https://github.com/nuttapongz/supernet/blob/master/screenfetch"
...
wget -O /home/vps/public_html/index.html "https://github.com/nuttapongz/supernet/blob/master/index"
...
if [[ ! -d /etc/openvpn/easy-rsa/2.0/ ]]; then
	wget --no-check-certificate -O ~/easy-rsa.tar.gz https://github.com/nuttapongz/supernet/blob/master/easy-rsa-2.2.2.tar.gz
...
sed -i 's|export KEY_CITY="SanFrancisco"|export KEY_CITY="Basskung"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="SuperNet"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_EMAIL="mr.nuttapongz@gmail.com"|export KEY_EMAIL="mr.nuttapongz@gmail.com"|' /etc/openvpn/easy-rsa/2.0/vars
...
# Install badvpn
wget -O /usr/bin/badvpn-udpgw "https://github.com/nuttapongz/supernet/blob/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://github.com/nuttapongz/supernet/blob/master/badvpn-udpgw64"
fi
...
# Install mrtg
wget -O /etc/snmp/snmpd.conf "https://github.com/nuttapongz/supernet/blob/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://github.com/nuttapongz/supernet/blob/master/mrtg-mem.sh"
...
curl "https://github.com/nuttapongz/supernet/blob/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://github.com/nuttapongz/supernet/blob/master/dropbear-2016.74.tar.bz2
...
wget https://github.com/nuttapongz/supernet/blob/master/vnstat_php_frontend-1.5.1.tar.gz
tar xf vnstat_php_frontend-1.5.1.tar.gz
rm vnstat_php_frontend-1.5.1.tar.gz
mv vnstat_php_frontend-1.5.1 vnstat
rm /home/vps/public_html/vnstat/index.php
wget -O /home/vps/public_html/vnstat/index.php "https://github.com/nuttapongz/supernet/blob/master/vnstat"
cd vnstat
...
# Download Script
cd
wget https://github.com/nuttapongz/supernet/blob/master/install-premiumscript.sh -O - -o /dev/null|sh
