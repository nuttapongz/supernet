...
sed -i 's|export KEY_CITY="SanFrancisco"|export KEY_CITY="KunTae"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="TaRuMa"|' /etc/openvpn/easy-rsa/2.0/vars
...
echo ""  | tee -a log-install.txt
echo "----------- Script Server VPS By SuperNet ------------"
